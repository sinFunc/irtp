 ...
 *      Test suite file     : /home/sean/installBySrc/mbedtls-2.28.3/tests/suites/test_suite_psa_crypto_op_fail.function
 *      Test suite data     : /home/sean/installBySrc/mbedtls-2.28.3/tests/suites/test_suite_psa_crypto_op_fail.generated.data
 *
 */
...
#line 2 "/home/sean/installBySrc/mbedtls-2.28.3/tests/suites/test_suite_psa_crypto_op_fail.function"
...
#line 45 "/home/sean/installBySrc/mbedtls-2.28.3/tests/suites/test_suite_psa_crypto_op_fail.function"
...
#line 72 "/home/sean/installBySrc/mbedtls-2.28.3/tests/suites/test_suite_psa_crypto_op_fail.function"
...
#line 118 "/home/sean/installBySrc/mbedtls-2.28.3/tests/suites/test_suite_psa_crypto_op_fail.function"
...
#line 164 "/home/sean/installBySrc/mbedtls-2.28.3/tests/suites/test_suite_psa_crypto_op_fail.function"
...
#line 206 "/home/sean/installBySrc/mbedtls-2.28.3/tests/suites/test_suite_psa_crypto_op_fail.function"
...
#line 260 "/home/sean/installBySrc/mbedtls-2.28.3/tests/suites/test_suite_psa_crypto_op_fail.function"
...
#line 307 "/home/sean/installBySrc/mbedtls-2.28.3/tests/suites/test_suite_psa_crypto_op_fail.function"
...
#line 325 "/home/sean/installBySrc/mbedtls-2.28.3/tests/suites/test_suite_psa_crypto_op_fail.function"
...
int get_expression(int32_t exp_id, int32_t *out_value)
{
    ...
    switch (exp_id) {
        ...
        case 50:
            {
                *out_value = PSA_ALG_AT_LEAST_THIS_LENGTH_MAC(PSA_ALG_HMAC(PSA_ALG_MD2),1);
            }
            break;
        case 51:
            {
                *out_value = PSA_ALG_AT_LEAST_THIS_LENGTH_MAC(PSA_ALG_HMAC(PSA_ALG_MD4),1);
            }
            break;
        case 52:
            {
        ...
        case 72:
            {
                *out_value = PSA_ALG_DETERMINISTIC_DSA(PSA_ALG_MD2);
            }
            break;
        case 73:
            {
                *out_value = PSA_ALG_DETERMINISTIC_DSA(PSA_ALG_MD4);
            }
            break;
        case 74:
            {
        ...
        case 81:
            {
                *out_value = PSA_ALG_DETERMINISTIC_ECDSA(PSA_ALG_MD2);
            }
            break;
        case 82:
            {
                *out_value = PSA_ALG_DETERMINISTIC_ECDSA(PSA_ALG_MD4);
            }
            break;
        case 83:
            {
        ...
        case 91:
            {
                *out_value = PSA_ALG_DSA(PSA_ALG_MD2);
            }
            break;
        case 92:
            {
                *out_value = PSA_ALG_DSA(PSA_ALG_MD4);
            }
            break;
        case 93:
            {
        ...
        case 102:
            {
                *out_value = PSA_ALG_ECDSA(PSA_ALG_MD2);
            }
            break;
        case 103:
            {
                *out_value = PSA_ALG_ECDSA(PSA_ALG_MD4);
            }
            break;
        case 104:
            {
        ...
        case 117:
            {
                *out_value = PSA_ALG_HKDF(PSA_ALG_MD2);
            }
            break;
        case 118:
            {
                *out_value = PSA_ALG_HKDF(PSA_ALG_MD4);
            }
            break;
        case 119:
            {
        ...
        case 149:
            {
                *out_value = PSA_ALG_RSA_OAEP(PSA_ALG_MD2);
            }
            break;
        case 150:
            {
                *out_value = PSA_ALG_RSA_OAEP(PSA_ALG_MD4);
            }
            break;
        case 151:
            {
        ...
        case 159:
            {
                *out_value = PSA_ALG_RSA_PKCS1V15_SIGN(PSA_ALG_MD2);
            }
            break;
        case 160:
            {
                *out_value = PSA_ALG_RSA_PKCS1V15_SIGN(PSA_ALG_MD4);
            }
            break;
        case 161:
            {
        ...
        case 170:
            {
                *out_value = PSA_ALG_RSA_PSS(PSA_ALG_MD2);
            }
            break;
        case 171:
            {
                *out_value = PSA_ALG_RSA_PSS(PSA_ALG_MD4);
            }
            break;
        case 172:
            {
        ...
        case 180:
            {
                *out_value = PSA_ALG_RSA_PSS_ANY_SALT(PSA_ALG_MD2);
            }
            break;
        case 181:
            {
                *out_value = PSA_ALG_RSA_PSS_ANY_SALT(PSA_ALG_MD4);
            }
            break;
        case 182:
            {
        ...
        case 203:
            {
                *out_value = PSA_ALG_TLS12_PRF(PSA_ALG_MD2);
            }
            break;
        case 204:
            {
                *out_value = PSA_ALG_TLS12_PRF(PSA_ALG_MD4);
            }
            break;
        case 205:
            {
        ...
        case 212:
            {
                *out_value = PSA_ALG_TLS12_PSK_TO_MS(PSA_ALG_MD2);
            }
            break;
        case 213:
            {
                *out_value = PSA_ALG_TLS12_PSK_TO_MS(PSA_ALG_MD4);
            }
            break;
        case 214:
            {
        ...
        case 223:
            {
                *out_value = PSA_ALG_TRUNCATED_MAC(PSA_ALG_HMAC(PSA_ALG_MD2),1);
            }
            break;
        case 224:
            {
                *out_value = PSA_ALG_TRUNCATED_MAC(PSA_ALG_HMAC(PSA_ALG_MD4),1);
            }
            break;
        case 225:
            {
